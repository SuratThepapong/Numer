...
class BisectionMethod extends Component {
  ...
  constructor() {
    super();
    this.state = { function: " ", Xr: " ", Xl: " ", X: 0, showGrap: false, showTable: false, items: [] }
  ...
  onSubmit() {
    if (this.state.Xl < this.state.Xr && this.state.function != " " && this.state.Xl != " " && this.state.Xr != " ") {
      ...
      do {
        ...
        fxr[n] = this.funcChange(inputy['xr'][n])
        fxl[n] = this.funcChange(inputy['xl'][n])
        ...
        inputy['xm'][n] = xm
        if (n > 0) {
          sum = this.funcError(xm, inputy['xm'][n - 1])
          inputy['error'][n] = sum
        }
        n++;
      } while (sum > 0.000001)
          ...
          <div width={10000}>
            <Form>
              ...
              <div>
                ...
                <Button href="/products"> Reset </Button>
